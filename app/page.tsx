...
export default function LandingPage() {
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] selection:bg-white/20">
      ...
      <footer className="relative z-10 border-t border-white/5 py-16 mx-auto px-6 flex flex-col items-center justify-center gap-3.5 text-center">
        ...
        <p className="text-[13px] font-light tracking-wide text-white/50 leading-relaxed">
          Engineered with precision by <span className="font-medium text-white/80">Ankit Kumar Gupta</span>
        </p>
        <p className="text-[10px] tracking-widest text-white/20 font-mono">
          NEXT.JS · TAILWIND CSS · PRISMA · GEMINI AI
        </p>
      </footer>
    </main>
  );
